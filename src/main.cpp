...
napi_value getEventLoop(napi_env env, napi_callback_info args) {
  uv_loop_t *loop;
  ...
  {
    napi_value i;
    napi_status napi_create_int32(env, 0xFFFFFFFF & ((uintptr_t)loop >> 32), &i);
  }
  {
    napi_value i;
    napi_status napi_create_int32(env, 0xFFFFFFFF & (uintptr_t)loop, &i);
  }
...
napi_value doDlclose(napi_env env, napi_callback_info args) {
  ...
  napi_value thisArg;
  void *data;
  napi_status napi_get_cb_info(env, args, &argc, argv, &thisArg, &data);
...
napi_value Init(napi_env env, napi_value exports) {
  ...
  napi_value getEventLoopFn;
  napi_create_function(env, NULL, 0, getEventLoop, NULL, &getEventLoopFn);
  napi_set_named_property(env, exports, "getEventLoop", getEventLoopFn);
